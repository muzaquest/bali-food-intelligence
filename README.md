...
🌤️ ВНЕШНИЕ ФАКТОРЫ
────────────────────────────────────────────────────────────────────────────
🌧️ Дождливые дни: 18 дней (29.5% периода)
🎉 Праздничные дни: 8 дней (13.1% периода)
📅 Выходные: 16 дней (26.2% периода)
🌡️ Средняя температура: 28.5°C
🌦️ Общие осадки: 245.8мм за период
...
💸 Потерянная выручка GOJEK: 618,500 IDR (~4 заказа)
🚫 Исключено fake orders: 376 (270 GRAB + 106 GOJEK)
✅ Качество данных: высокое (99.8% успешных заказов)
