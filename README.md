...
────────────────────────────────────────────────────────────────────────────
💰 Выплаты:
   ├── 📱 GRAB: 275,831,914 IDR
   └── 🛵 GOJEK: данные недоступны
...
────────────────────────────────────────────────────────────────────────────
🟢 GRAB:
├── ⏰ Время ожидания водителей: 35.1 мин
└── 📉 Offline rate: 10.0%

🟠 GOJEK:
├── ⏱️ Время приготовления: данные недоступны
├── 🚗 Время доставки: данные недоступны  
...
💔 Реальные потери от операционных проблем:
   ├── 💸 GRAB отмененные: точная сумма недоступна
   ├── 💸 GOJEK потерянные: 618,500 IDR (конкретные заказы)
   └── 📊 Общие потери: ~1,200,000 IDR (0.25% от выручки)

⏱️ Качество обслуживания:
   ├── ✅ GRAB процент выполненных: 99.9%
   ├── ✅ GOJEK процент выполненных: 99.1%
   └── 🚫 Исключено fake orders: 376 (270 GRAB + 106 GOJEK)

🔧 ОПЕРАЦИОННЫЕ СБОИ ПЛАТФОРМ:
├── 📱 GRAB: критичные сбои с потерями
├── 🛵 GOJEK: минимальные сбои (close time: 0.1 мин)
└── 💸 Потенциальные потери: требует детального анализа
