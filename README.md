...
────────────────────────────────────────────────────────────────────────────
🚫 Отмененные заказы:
   ├── 📱 GRAB: 122 заказа (отмена по различным причинам)
   └── 🛵 GOJEK: 180 заказов (отмена по различным причинам)
   💡 Всего отмененных: 302 заказа (11.3% от общих)

💔 Реальные потери от операционных проблем:
   ├── 💸 GRAB отмененные: 27,142,194 IDR (122 × 222,477 IDR средний чек)
   ├── 💸 GOJEK отмененные: 32,729,040 IDR (180 × 181,828 IDR средний чек)
   └── 📊 Общие потери: 59,871,234 IDR (12.3% от выручки)

💸 GRAB CANCELLED LOSSES (детальный анализ):
   📊 Анализ причин отмен GRAB по среднему чеку 222,477 IDR:
   ├── 🔢 Всего отмененных заказов: 122
   ├── 💰 Общие потери: 27,142,194 IDR  
   ├── 📈 Процент от общей выручки GRAB: 7.2%
   └── ⚠️ Критично: требует оптимизации процессов заказов
...
**📊 КРАТКОЕ РЕЗЮМЕ**
За период апрель-май 2025 обнаружено 3 критических дня с серьезным падением продаж. ML анализ выявил: отсутствие данных GRAB (50% влияния), балийские праздники (20% влияния) и операционные сбои платформ (7% влияния).

---

**📉 ХУДШИЙ ДЕНЬ: 21 апреля 2025**
💰 **Продажи:** 1,793,000 IDR (-77.5% к среднему)
...
**📉 ПРОБЛЕМНЫЙ ДЕНЬ: 8 апреля 2025**  
💰 **Продажи:** 4,782,300 IDR (-39.3% к медиане)

🔎 **Причины снижения:**
- 🎭 **Odalan Temple Festival** (-20%) — балийский праздник снижает заказы
- 🌦️ **Дождь 5.7мм** (-2%) — легкий дождь
- ✅ **ROAS хороший 8.3x** — реклама работала эффективно
- ✅ **Рейтинги высокие** — GRAB 4.8, GOJEK 4.8
...
- 🌤️ **Комфортная температура 23.2°C** (+3%) — оптимальная для заказов
- ⚠️ **Дождь 34.0мм** (-2%) — минимально повлиял благодаря празднику
...
1. **Отсутствие данных платформ** — потеря 50% выручки при сбое GRAB
2. **Балийские праздники** — снижение продаж на 20% в дни храмовых церемоний  
3. **Операционные сбои** — закрытие платформ на 1+ час дает -7% продаж
4. **Эффективность рекламы** — ROAS >15x обеспечивает максимальную прибыль

**📱 Стратегические рекомендации:**
- 🔧 Настроить надежный мониторинг API подключений к платформам
- 📊 Создать резервные каналы получения данных от GRAB/GOJEK
- 🎭 Планировать снижение активности в балийские религиозные праздники
- 🎯 Увеличивать рекламный бюджет в буддистские праздники (Vesak Day)
