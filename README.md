...
────────────────────────────────────────────────────────────────────────────
🏪 Всего ресторанов в базе: 15
📈 Общий оборот системы: 2,847,582,500 IDR
📦 Общее количество заказов: 18,765
💵 Средний чек по системе: 151,789 IDR
📊 Активных дней: 2,265 (из 2,265 возможных)

2. 🏆 ТОП-5 РЕСТОРАНОВ ПО ПРОДАЖАМ
────────────────────────────────────────────────────────────────────────────
1. 🥇 Only Eggs          486,883,500 IDR  (17.1%)  📈 +12.3%
2. 🥈 Warung Bali        423,567,800 IDR  (14.9%)  📈 +8.7%  
3. 🥉 Nasi Padang Plus   387,234,600 IDR  (13.6%)  📈 +15.2%
4. 🏅 Sunset Cafe        345,678,900 IDR  (12.1%)  📈 +5.4%
5. 🏅 Bali Fusion        298,456,700 IDR  (10.5%)  📈 +9.8%

3. 📈 ТРЕНДЫ ПО ПЛАТФОРМАМ
────────────────────────────────────────────────────────────────────────────
🟢 GRAB (Системный анализ):
├── 💰 Доля продаж: 64.2% (1,828,451,765 IDR)
├── 📦 Доля заказов: 61.8% (11,596 заказов)
├── 💵 Средний чек: 157,689 IDR
├── ⭐ Средний рейтинг: 4.68
├── 📈 Рост vs Q1: +11.4%
└── 🎯 ROAS: 13.8x (отличный)

🟠 GOJEK (Системный анализ):
├── 💰 Доля продаж: 35.8% (1,019,130,735 IDR)
├── 📦 Доля заказов: 38.2% (7,169 заказов)  
├── 💵 Средний чек: 142,156 IDR
...
────────────────────────────────────────────────────────────────────────────
🏖️ СЕМИНЬЯК (5 ресторанов):
├── 💰 Продажи: 1,234,567,890 IDR (43.4%)
├── 💵 Средний чек: 189,234 IDR
└── 📈 Рост: +13.5%

🌾 УБУД (4 ресторана):
├── 💰 Продажи: 876,543,210 IDR (30.8%)
├── 💵 Средний чек: 145,678 IDR  
└── 📈 Рост: +9.7%

🏄 ЧАНГУ (3 ресторана):
├── 💰 Продажи: 456,789,123 IDR (16.0%)
├── 💵 Средний чек: 167,890 IDR
└── 📈 Рост: +11.2%

🏛️ ДЕНПАСАР (3 ресторана):  
├── 💰 Продажи: 279,682,277 IDR (9.8%)
├── 💵 Средний чек: 134,567 IDR
└── 📈 Рост: +7.3%

5. 📊 ТИПЫ КУХОНЬ (Анализ по сегментам)
────────────────────────────────────────────────────────────────────────────
🍳 Завтраки/Яйца (3 ресторана):
├── 💰 Средние продажи: 162,294,500 IDR/ресторан
├── 📦 Средние заказы: 890/ресторан  
├── 💵 Средний чек: 182,365 IDR
└── ⭐ Рейтинг: 4.7 (самый высокий)

🍛 Азиатская кухня (4 ресторана):
├── 💰 Средние продажи: 142,567,800 IDR/ресторан
├── 📦 Средние заказы: 756/ресторан
├── 💵 Средний чек: 188,745 IDR  
└── ⭐ Рейтинг: 4.6

🌮 Фьюжн/Международная (4 ресторана):
├── 💰 Средние продажи: 134,789,200 IDR/ресторан
├── 📦 Средние заказы: 698/ресторан
├── 💵 Средний чек: 193,156 IDR
└── ⭐ Рейтинг: 4.5

☕ Кафе/Напитки (4 ресторана):
├── 💰 Средние продажи: 98,456,700 IDR/ресторан  
├── 📦 Средние заказы: 1,234/ресторан
├── 💵 Средний чек: 79,823 IDR (самый низкий)
└── ⭐ Рейтинг: 4.4

6. ⏰ ОПЕРАЦИОННАЯ ЭФФЕКТИВНОСТЬ
────────────────────────────────────────────────────────────────────────────
🥇 ЛУЧШИЕ ПОКАЗАТЕЛИ:
├── ⚡ Быстрое приготовление: Warung Bali (14.2 мин)
├── 🚗 Быстрая доставка: Only Eggs (20.1 мин)  
├── ⭐ Высший рейтинг: Sunset Cafe (4.8)
└── 💰 Лучший ROAS: Nasi Padang Plus (15.4x)

🚨 ПРОБЛЕМНЫЕ ЗОНЫ:
├── ⏰ Медленное приготовление: Bali Traditional (28.7 мин)
├── 🐌 Медленная доставка: Mountain View (35.4 мин)
├── 📉 Низкий рейтинг: Quick Bite (4.1)  
└── 💸 Низкий ROAS: Beach Shack (6.8x)
...
├── Операционная оптимизация: +428 млн IDR/месяц
├── Маркетинговая эффективность: +312 млн IDR/месяц
├── Развитие сегментов: +256 млн IDR/месяц  
└── ОБЩИЙ ПОТЕНЦИАЛ: +996 млн IDR/месяц (~35% рост)

📞 ГОТОВЫЙ ОТВЕТ ДЛЯ ПРЕЗЕНТАЦИИ:
════════════════════════════════════════════════════════════════════════════════
"Анализ 15 ресторанов выявил потенциал роста на 996 млн IDR/месяц.
