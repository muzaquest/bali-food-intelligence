...
## ⚠️ ВАЖНОЕ ОБНОВЛЕНИЕ (20 Января 2025) 
...
⚠️ ВАЖНО: Предыдущие данные (1.22 триллиона) были неверными из-за ошибки в SQL запросах (декартово произведение). Исправлено 20 янв 2025.
