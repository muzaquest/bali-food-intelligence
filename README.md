...
============================================================
📊 ОБНАРУЖЕНО 51 ЗНАЧИТЕЛЬНЫХ АНОМАЛИЙ:

 1. 2025-04-01: 🔴 📉 ПАДЕНИЕ на -35.9%
    💰 Продажи: 8,353,000 IDR (среднее: 13,022,602 IDR)
    🔍 ВЫЯВЛЕННЫЕ ПРИЧИНЫ:
       • 📈 РЕКЛАМА: сокращение бюджета на 32.7%
         📊 Влияние: -16.3%
         💡 Правило: Изменение рекламного бюджета влияет на продажи с коэффициентом ~0.5
       • ❓ НЕОБЪЯСНЕННОЕ ВЛИЯНИЕ: -19.5% (требует изучения)

 2. 2025-04-03: 🟢 📈 РОСТ на +18.7%
    💰 Продажи: 15,462,400 IDR (среднее: 13,022,602 IDR)
    🔍 ВЫЯВЛЕННЫЕ ПРИЧИНЫ:
       • 🤔 НЕИЗВЕСТНЫЕ ФАКТОРЫ: отклонение +18.7% требует дополнительного анализа
       • ❓ НЕОБЪЯСНЕННОЕ ВЛИЯНИЕ: +18.7% (требует изучения)

 3. 2025-04-04: 🟢 📈 РОСТ на +25.9%
    💰 Продажи: 16,398,100 IDR (среднее: 13,022,602 IDR)
    🔍 ВЫЯВЛЕННЫЕ ПРИЧИНЫ:
       • 📈 РЕКЛАМА: сокращение бюджета на 31.6%
         📊 Влияние: -15.8%
         💡 Правило: Изменение рекламного бюджета влияет на продажи с коэффициентом ~0.5
       • 📅 ДЕНЬ НЕДЕЛИ: Friday - выходные дают прирост
         📊 Влияние: +15.0%
         💡 Правило: Выходные дни дают +15-25% к продажам
       • ❓ НЕОБЪЯСНЕННОЕ ВЛИЯНИЕ: +26.7% (требует изучения)

📈 КОРРЕЛЯЦИОННЫЙ АНАЛИЗ ФАКТОРОВ:
• 📈 Реклама ↔ Продажи: 0.63 (увеличение бюджета на 50% ≈ рост продаж на 19%)
• 🚫 Отмены 'закрыто': 2.4% дней → потеря потенциальных заказов
