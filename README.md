...
ℹ️ **ВАЖНО:** Маркетинговый анализ фокусируется на ТОП-15 ресторанов по объему продаж из общих 59 активных ресторанов в базе. Эти лидеры представляют основную долю рынка и имеют наиболее значимые данные для анализа трендов.
...
💰 РАЗМЕР И СТРУКТУРА РЫНКА:
   ...
   🏝️ КОНТЕКСТ: Бали принял 6.3 млн туристов в 2024 (цель 2025: 6.5 млн)
