...
💰 РАЗМЕР И СТРУКТУРА РЫНКА:
   ...
   💰 РАЗМЕР РЫНКА: 15 млрд IDR
   📊 ОЦЕНКА: Локальный сегмент ресторанного рынка Индонезии
   📈 КОНТЕКСТ: Общий рынок foodservice Индонезии ~950 трлн IDR (2025)
   🎯 ДОЛЯ: Анализируемый сегмент составляет ~0.016% от общего рынка
