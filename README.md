...
🔎 **Причины снижения:**
- 🎭 **Odalan Temple Festival** (-25%) — балийский праздник снижает заказы
- 🌧️ **Умеренный дождь 8.3мм** (-10%) — существенно снижает активность курьеров
- 🌡️ **Повышенная температура 27.7°C** (-2%) — жаркая погода
