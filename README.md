...
🔎 **Причины падения:**
- 🚨 **GRAB сбой 5ч 57м** (-40%) — платформа была недоступна 24.8% дня
- 📊 **GOJEK данные отсутствуют** (-30%) — техническая проблема сбора данных
- ✅ **GRAB реклама работала** — ROAS 11.1x при наличии доступа
- 📅 **Среда** — обычно средние показатели

💡 **Что делать:**
- 🔧 Внедрить мониторинг доступности GRAB API
- 📊 Настроить backup каналы получения данных GOJEK
- ⚠️ Создать алерты при отсутствии данных >2 часов
...
- ⚠️ Различать технические проблемы и реальное отсутствие продаж
