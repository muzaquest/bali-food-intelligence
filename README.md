...
🔎 **Причины падения:**
- 🚨 **Grab полностью не работал** (-45%) — платформа была недоступна весь день
- 🌧️ **Дождливая погода** (-20%) — 4.1мм осадков снизили заказы доставки  
- 📉 **Низкий средний чек** (-15%) — 179,000 IDR вместо обычных 250,000 IDR
- 📱 **Слабая реклама** (-10%) — только 47 показов против обычных 200+
- ⏰ **Долгое приготовление** (-5%) — 24.6 минут вместо обычных 18 минут

💡 **Что делать:**
- Договориться с Grab о резервном канале связи при сбоях
- Запустить "дождевые" акции: "Горячая еда в холодную погоду"
- Пересмотреть рекламную стратегию в дни низкого трафика
...
🔎 **Причины снижения:**
- 🌦️ **Умеренный дождь** (-25%) — 9.1мм осадков в течение дня
- 🛵 **Мало заказов Gojek** (-15%) — только 10 заказов против обычных 25
- 🏪 **Активность конкурентов** (-10%) — 3 новых ресторана в районе
- ✅ **Хорошая реклама Grab** (+15%) — ROAS 11.9 компенсировала часть потерь

💡 **Рекомендации:**
- Усилить присутствие в Gojek: проверить видимость в поиске
- Мониторить конкурентов: анализировать их акции и цены
- Развивать "погодные" меню: теплые супы и горячие напитки
...
🔎 **Факторы успеха:**
- ☀️ **Отличная погода** (+25%) — солнечный день, 28°C, туристы активны
- 💰 **Высокий средний чек** (+20%) — 381,000 IDR против обычных 250,000 IDR
- 📢 **Эффективная реклама** (+15%) — 357 показов, ROAS 14.3 в Grab
- 🎯 **Много заказов** (+10%) — 54 заказа против обычных 35
- 📅 **Воскресенье** (+5%) — выходной день увеличил трафик

💡 **Что повторить:**
- Увеличивать рекламный бюджет в солнечные выходные дни
- Продвигать крупные семейные заказы (комбо-наборы)
- Готовить больше популярных блюд в хорошую погоду
