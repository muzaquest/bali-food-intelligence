...
• Маркетинг и ROAS: ТОЛЬКО GRAB (GOJEK не предоставляет эти данные)
...
📊 GOJEK не предоставляет данные о маркетинговых кампаниях, воронке продаж и ROAS
💡 Для полной картины необходимо запросить маркетинговые данные у GOJEK
