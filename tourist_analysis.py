...
def analyze_tourist_data():
    ...
    try:
        ...
        # Загружаем научные туристические коэффициенты
        try:
            ...
            # Fallback к эмпирическим данным если файл не найден
            print("⚠️ Файл научных коэффициентов не найден, используем эмпирические данные")
            tourist_patterns = {
                "высокий_сезон": {
