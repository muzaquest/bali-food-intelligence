...
def analyze_tourist_data():
    ...
    try:
        ...
        # Загружаем реальные туристические коэффициенты из файла Бали
        try:
            with open('real_tourist_correlations.json', 'r', encoding='utf-8') as f:
                ...
                print("✅ Загружены РЕАЛЬНЫЕ туристические коэффициенты из файла Бали (Kunjungan_Wisatawan_Bali_2025.xls)")
