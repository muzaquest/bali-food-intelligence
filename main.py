...
def analyze_restaurant(restaurant_name, start_date=None, end_date=None):
    ...
    print()
    print("⚠️ МЕТОДОЛОГИЯ РАСЧЕТОВ:")
    print("• Заказы: включены все заказы из систем платформ")
    print("• Средний чек: общие продажи ÷ общие заказы")
    print("• ROAS: атрибуционная модель (GRAB точная, GOJEK периодная)")
    print()
